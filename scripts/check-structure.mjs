...
const required = [
  ...
  "src/contracts/timed-action-definition.js",
  ...
  "src/core/combat/timed-action-resolver.js",
  "src/core/combat/utility-action-resolver.js",
  ...
  "tests/unit/utility-actions.test.mjs",
];
